...
| 파트 | 멤버 | 담당 |
| --- | --- | --- |
| 기획 · 디자인 | 정유빈 (이화여대) | 서비스 기획, UI/UX 디자인 |
| Frontend | 문지호 (연세대), 윤서영 (홍익대) | 카카오 지도 Web API 연동, 지도 UI, 장소 검색, 학교별 데이터 시각화 |
| Backend | 김윤진 (서강대), 송승환 (홍익대), 윤수빈 (명지대) | 맛집·완료 데이터 저장/조회, 학교별 집계·랭킹, 인증 |
